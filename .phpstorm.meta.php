...
'hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','images.default',
...
'fortify.limiters.passkeys','fortify.paths.login','fortify.paths.logout','fortify.paths.password.request','fortify.paths.password.reset',
...
'inertia.ssr.enabled','inertia.ssr.url','inertia.pages.paths','inertia.pages.extensions','inertia.testing.ensure_pages_exist',
...
'logging.channels.daily.max_files','logging.channels.daily.replace_placeholders','logging.channels.monthly.driver','logging.channels.monthly.path','logging.channels.monthly.level',
...
'session.same_site','session.partitioned','session.serialization','boost.enabled','boost.rules.enabled',
'boost.rules.scoped_guidelines','boost.guidelines.exclude','boost.skills.exclude','boost.executable_paths.php','boost.executable_paths.composer',
'boost.executable_paths.npm','boost.executable_paths.vendor_bin','boost.executable_paths.current_directory','boost.browser_logs_watcher','boost.browser_log_levels',
...
'signed','throttle','verified','role',);
        registerArgumentsSet('routes', 'boost.browser-logs','login','login.store',
...
'home','dashboard','venues.index','venues.create','venues.store',
'venues.show','venues.edit','venues.update','venues.destroy','events.index',
'events.create','events.store','events.show','events.edit','events.update',
'events.destroy','google.login','profile.edit',
